        ...
        <video 
            ...
            <div className="missionStatement">
                ...
                <div className="missionRight">
                    <img className="aboutoutdoor" src={baptism} alt="outdoor" />
                </div>
            </div>
            <div className = "ourMission" >
                <div className="ourMissionLeft">
                    ...
                    <div className="ourMissionTopL">
                        <img className="aboutoutdoor" src={water} alt="outdoor" />
                    </div>
                </div>
            ...
            <div className="statementOfFaith">
                ...
                <div className="statementOfFaithContainer">
                    ...
                    <img className="outdoor" src={cross} alt="outdoor" />
                        <h2>Holy Bible</h2>
                        ...
                        <img className="outdoor" src={lastSupper} alt="outdoor" />
                    ...
                    <h2>Jesus Christ</h2>
                        ...
                        <img className="outdoor" src={bible} alt="outdoor" />
                        <h2>The Church</h2>
                        ...
                        <img className="outdoor" src={jesus} alt="outdoor" />
                        <h2>Heaven</h2>
