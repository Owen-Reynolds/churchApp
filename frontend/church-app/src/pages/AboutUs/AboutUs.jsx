        ...
        <video 
            ...
            <div className="missionStatement">
                ...
                <div className="missionRight">
                    <img className="aboutoutdoor" src={baptism} alt="outdoor" loading="lazy" decoding="async" />
                </div>
            </div>
            <div className = "ourMission" >
                <div className="ourMissionLeft">
                    ...
                    <div className="ourMissionTopL">
                        <img className="aboutoutdoor" src={water} alt="outdoor" loading="lazy" decoding="async" />
                    </div>
                </div>
            ...
            <div className="ourStory">
                ...
                <div className="ourStoryRight">
                    ...
                    <img className="aboutoutdoor" src={group2} alt="outdoor" loading="lazy" decoding="async" />
                </div>
            </div>
            <div className="statementOfFaith">
                <div className="statementOfFaithHeader">
                    <h1>Statement of Faith</h1>
                </div>
                <div className="statementOfFaithContainer">
                    <div className="statementOfFaithLeft">
                    <img className="outdoor" src={cross} alt="outdoor" loading="lazy" decoding="async" />
                        <h2>Holy Bible</h2>
                        ...
                        <img className="outdoor" src={lastSupper} alt="outdoor" loading="lazy" decoding="async" />
                    ...
                    <div className="statementOfFaithRight">
                    <h2>Jesus Christ</h2>
                        ...
                        <img className="outdoor" src={bible} alt="outdoor" loading="lazy" decoding="async" />
                        <h2>The Church</h2>
                        ...
                        <img className="outdoor" src={jesus} alt="outdoor" loading="lazy" decoding="async" />
                        <h2>Heaven</h2>
